### DOGI prototype
This project includes a real prototype of a log-structured storage system using the DOGI placement policy.
We build this prototype upon SepBIT implementation
